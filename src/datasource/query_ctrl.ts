export class GlpiAppDatasourceQueryCtrl {
  ...
  constructor(public $scope, private $injector, private templateSrv, private $q, private uiSegmentSrv) {
    ...
    this.list = [];
    this.getListOptionsFields('all', this.target.console).then((data) => {
    ...
    this.listdate = [];
    this.getListOptionsFields('date', this.target.console).then((data) => {
    ...
    this.listnumber = [];
    this.getListOptionsFields('number', this.target.console).then((data) => {
      $scope.ctrl.listnumber = data;
    });
