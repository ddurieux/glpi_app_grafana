...
import { GLPIQuery, GLPIOptions, QueryType } from '../types';

export class GlpiAppDatasource extends DataSourceApi<GLPIQuery, GLPIOptions> {
  ...
  constructor(public instanceSettings: DataSourceInstanceSettings<GLPIOptions>) {
  ...
  async query(options: DataQueryRequest<GLPIQuery>): Promise<DataQueryResponse> {
